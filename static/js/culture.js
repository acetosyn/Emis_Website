(function () {
    ...
    const sliderStage = document.getElementById("cultureRoyalStage");
    const indicatorWrap = document.getElementById("cultureRoyalIndicators");

    if (!sliderStage || !indicatorWrap) return;

    const slides = Array.from(sliderStage.querySelectorAll(".culture-slider-grid"));
